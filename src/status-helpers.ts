...
export const isPendingStatus = (status: CodingSchemeStatus): boolean => status === CODING_SCHEME_STATUS.CODING_INCOMPLETE || status === CODING_SCHEME_STATUS.DERIVE_PENDING;
